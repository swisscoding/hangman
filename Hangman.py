...
"""
First you have to install colored --> pip/pip3 install colored
The shebang line above is for ./Hangman.py in terminal, but you can ignore that
if you do it this way: python/python3 Hangman.py

More about colored library: https://pypi.org/project/colored/
"""
...
guesses = 8
user_guess_list = []
welcome_str = "Welcome to CLI-Hangman."
decorator = ""
global rand_index
